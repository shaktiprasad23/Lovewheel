...
const febHolidays = [
    ...
    "And trust me I donot want anyone else",
    "There's no one better than you❤️",
    "You're the best rani saheeba!!",
    "Or should I say, mo gro coco d'amour que j'adore a la folie XD",
    "Wow!! Time flies, we've already been together ",
    ...
    "But anyways, Happy 3 month my sweet little girlfriend(wife🤭)",
